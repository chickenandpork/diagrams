...
def _write_build(rctx, path, version):
    ...
    rctx.template(
        ...
        substitutions = {
            "{GENERATOR}": "@com_github_chickenandpork_diagrams//toolchains/dot/dot_configure.bzl%find_system_dot",
...
def find_system_dot(virtual_dependency_name, verbose = False):
    ...
    native.register_toolchains(
        ...
        "@com_github_chickenandpork_diagrams//toolchains/dot:dot_missing_toolchain",
    )
